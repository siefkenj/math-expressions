...
const objectsToTest = [
  ...
  {
    ast: ["-", ["+", "z", ["/", -2, 3]]],
    latex: "-\\left(z - \\frac{2}{3}\\right)",
  },
  {
    ast: ["*", "z", ["/", -2, 3]],
    latex: "z \\left(-\\frac{2}{3}\\right)",
  },
  {
    ast: ["*", "z", ["/", ["-", "a"], 3]],
    latex: "z \\left(-\\frac{a}{3}\\right)",
  },
  {
    ast: ["*", "z", ["/", ["*", -2, "x"], 3]],
    latex: "z \\left(-\\frac{2 x}{3}\\right)",
  },
  {
    ast: ["*", "z", ["/", ["*", ["-", "a"], "x"], 3]],
    latex: "z \\left(-\\frac{a x}{3}\\right)",
  },
  {
    ast: ["*", "y", ["/", 1, 2], "x"],
    latex: "y \\frac{1}{2} x",
  ...
  {
    ast: ["gts", ["tuple", "x", "y", "z"], ["tuple", true, true]],
    latex: "x > y > z",
  },
  {
    ast: ["gts", ["tuple", "x", "y", "z"], ["tuple", true, false]],
    latex: "x > y \\ge z",
  },
  {
    ast: ["gts", ["tuple", "x", "y", "z"], ["tuple", false, true]],
    latex: "x \\ge y > z",
  },
  {
    ast: ["gts", ["tuple", "x", "y", "z"], ["tuple", false, false]],
    latex: "x \\ge y \\ge z",
  },
  {
    ast: ["<", "x", "y"],
  ...
  {
    ast: ["lts", ["tuple", "x", "y", "z"], ["tuple", true, true]],
    latex: "x < y < z",
  },
  {
    ast: ["lts", ["tuple", "x", "y", "z"], ["tuple", true, false]],
    latex: "x < y \\le z",
  },
  {
    ast: ["lts", ["tuple", "x", "y", "z"], ["tuple", false, true]],
    latex: "x \\le y < z",
  },
  {
    ast: ["lts", ["tuple", "x", "y", "z"], ["tuple", false, false]],
    latex: "x \\le y \\le z",
  },
  {
    ast: [">", ["<", "x", "y"], "z"],
  ...
  },
  {
    ...
    latex:
      "\\left(\\lnot \\left(x = y\\right)\\right) \\lor \\left(z \\ne w\\right)",
  },
  {
    ast: ["implies", ["and", "A", ["not", "B"]], ["or", ["not", "C"], "D"]],
    latex:
      "A \\land \\left(\\lnot B\\right) \\implies \\left(\\lnot C\\right) \\lor D",
  },
  {
    ast: ["impliedby", ["and", "A", ["not", "B"]], ["or", ["not", "C"], "D"]],
    latex:
      "A \\land \\left(\\lnot B\\right) \\impliedby \\left(\\lnot C\\right) \\lor D",
  },
  {
    ast: ["iff", ["and", "A", ["not", "B"]], ["or", ["not", "C"], "D"]],
    latex:
      "A \\land \\left(\\lnot B\\right) \\iff \\left(\\lnot C\\right) \\lor D",
  },
  {
    ast: ["rightarrow", ["and", "A", ["not", "B"]], ["or", ["not", "C"], "D"]],
    latex:
      "A \\land \\left(\\lnot B\\right) \\rightarrow \\left(\\lnot C\\right) \\lor D",
  },
  {
    ast: ["leftarrow", ["and", "A", ["not", "B"]], ["or", ["not", "C"], "D"]],
    latex:
      "A \\land \\left(\\lnot B\\right) \\leftarrow \\left(\\lnot C\\right) \\lor D",
  },
  {
    ast: [
      "leftrightarrow",
    ...
    latex:
      "A \\land \\left(\\lnot B\\right) \\leftrightarrow \\left(\\lnot C\\right) \\lor D",
  },
  {
    ast: ["in", "x", "emptyset"],
  ...
  },
  {
    ...
    latex:
      "\\begin{bmatrix} a + 3 y & 2 \\sin\\left(\\theta\\right) \\end{bmatrix}",
  },
  {
    ast: [
      "matrix",
...
test("pad to digits", function () {
  ...
  expect(converter.convert(0.123)).toEqual("0.12300");
  expect(converter.convert(0.0123)).toEqual("0.012300");
  expect(converter.convert(0.00123)).toEqual("0.0012300");
  expect(converter.convert(0.000123)).toEqual("0.00012300");
  ...
  expect(converter.convert(["*", 123, ["^", 10, 28]])).toEqual(
    "123.00 \\cdot 10^{28}",
  );
  expect(converter.convert(["*", 123, ["^", 10, -28]])).toEqual(
    "123.00 \\cdot 10^{-28}",
...
test("pad to decimals", function () {
  ...
  expect(converter.convert(123e28)).toEqual(
  ...
  expect(converter.convert(0.123)).toEqual("0.12300");
  expect(converter.convert(0.0123)).toEqual("0.01230");
  expect(converter.convert(0.00123)).toEqual("0.00123");
  expect(converter.convert(0.000123)).toEqual("0.000123");
...
test("pad to digits and decimals", function () {
  ...
  expect(converter.convert(1.23)).toEqual("1.23000");
  expect(converter.convert(0.123)).toEqual("0.123000");
  expect(converter.convert(0.0123)).toEqual("0.0123000");
  expect(converter.convert(0.00123)).toEqual("0.00123000");
  expect(converter.convert(0.000123)).toEqual("0.000123000");
