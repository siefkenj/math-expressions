...
pub fn math_mod(x: f64, y: f64) -> f64 {
    math_expressions::mathjs_compat::math_mod(x, y)
}
#[wasm_bindgen]
pub fn gcd(x: f64, y: f64) -> f64 {
    math_expressions::mathjs_compat::gcd_f64(x, y)
}
#[wasm_bindgen]
pub fn lcm(x: f64, y: f64) -> f64 {
    math_expressions::mathjs_compat::lcm_f64(x, y)
}
#[wasm_bindgen]
pub fn mean(data: Vec<f64>) -> f64 {
    math_expressions::mathjs_compat::mean(&data)
}
#[wasm_bindgen]
pub fn median(data: Vec<f64>) -> f64 {
    math_expressions::mathjs_compat::median(&data)
}
/// Unbiased sample variance (mathjs default).
#[wasm_bindgen]
pub fn variance(data: Vec<f64>) -> f64 {
    math_expressions::mathjs_compat::variance(&data)
}
#[wasm_bindgen]
pub fn std(data: Vec<f64>) -> f64 {
    math_expressions::mathjs_compat::std_dev(&data)
}
/// mathjs `quantileSeq` with linear interpolation.
#[wasm_bindgen]
pub fn quantile_seq(data: Vec<f64>, prob: f64) -> f64 {
    math_expressions::mathjs_compat::quantile_seq(&data, prob)
}
...
pub fn lusolve(a: Vec<f64>, b: Vec<f64>, n: usize) -> Option<Vec<f64>> {
    math_expressions::mathjs_compat::lusolve(&a, &b, n)
}
...
pub fn eigs(a: Vec<f64>, n: usize) -> Option<String> {
    let pairs = math_expressions::mathjs_compat::eigs(&a, n)?;
