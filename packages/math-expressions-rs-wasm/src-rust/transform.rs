...
impl Expression {
    ...
    pub fn collect_like_terms_factors(&self) -> Expression {
        self.derive(math_expressions::simplify(&self.0))
    }
    ...
    pub fn factor(&self) -> Expression {
        self.derive(math_expressions::factor(&self.0))
    }
    ...
    pub fn set_small_zero(&self, tolerance: f64) -> Expression {
        self.derive(math_expressions::set_small_zero(&self.0, tolerance))
    }
    ...
    pub fn altvectors_to_vectors(&self) -> Expression {
        self.derive(math_expressions::altvectors_to_vectors(&self.0))
    }
    ...
    pub fn strings_to_subscripts(&self) -> Expression {
        self.derive(math_expressions::strings_to_subscripts(&self.0))
    }
